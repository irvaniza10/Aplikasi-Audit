	...
	<table class="table">
		...
		<!-- <tr>
			<div class="form-group">
				<label></label>
				<td><a href="buka.php?audit_id=<?php echo $d['audit_id']; ?>" class="btn btn-info">Buka File</a>
				<a href="<?php echo $d['path'].$d['file_name']; ?>" class="btn btn-info" download="">Download</a></td>
				<td></td>
