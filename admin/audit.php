<?php include 'header.php'; include 'config.php'; //echo md5('');?>
...
if(isset($_GET['pesan'])){
	...
	if($pesan=="replace"){
		...
		echo "<div class='alert alert-danger'>Ekstensi file harus .xlsx, .pdf, .rar, atau .zip</div>";
...
<div class="col-md-12">
	...
	<a style="margin-bottom:10px" href="<?php if (isset($_GET['year'])){ echo "lap_audit.php?year=".$_GET['year'];}else {echo "lap_audit.php";}?>" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  Cetak</a>
</div>
<form action="cari_audit.php" method="get">
	<div class="input-group col-md-5 col-md-offset-7">
		<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-search"></span></span>
		<input type="text" class="form-control" placeholder="Cari audit di sini .." aria-describedby="basic-addon1" name="cari" value="<?php if(isset($_GET['cari']))echo htmlspecialchars($_GET['cari']); ?>">	
	</div>
</form>
<br/>
<form action="" method="get">
	<div class="input-group col-md-5 col-md-offset-7">
		...
		<select type="submit" name="year" id="tahun" class="form-control" onchange="this.form.submit()">
	...
	while($b=mysqli_fetch_array($brg)){
		...
		<tr>
			...
			<td>
				...
				<a href="edit_audit.php?audit_id=<?php echo $b['audit_id']; ?>" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span>Edit</a>
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='hapus_audit.php?audit_id=<?php echo $b['audit_id']; ?>' }" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span>Hapus</a>
			</td>
		</tr>		
		<?php 
	}
			...
			<div class="modal-body">
				<form action="tmb_audit_act.php" method="post" enctype="multipart/form-data">
					...
					<!-- <div class="form-group">
						...
						<div><h5><a style='color:red'>*ukuran file maksimum 10MB</a></h5></div>		
						<div class="form-group">
							<label></label>
...
<script type="text/javascript">
	...
	document.getElementById('tahun').value = "<?php if(isset($_GET['year'])){echo $_GET['year'];}?>";
</script>
